...
def custom_pipeline_example():
    ...
    text_to_process = """
    The research findings indicate that regular exercise contributes to improved 
    cognitive function and enhanced mood regulation through the release of endorphins.
    """
